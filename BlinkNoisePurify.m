function [purifiedData,blinktimes,errorflag,purify_times] = BlinkNoisePurify(inputdata,pupilcol)
...
for i=1:100
    if i == 1
        [blink_time_data,blink_timesi,resultFlag] = blink_treatment_pupil1(inputdata,pupilcol);
        ...
        [blink_time_datai,blink_timesi,Flagi] = blink_treatment_pupil1(checked_data,pupilcol);
