...
function [blink_time_data,blink_time,resultFlag]=blink_treatment_pupil1(eyedata,pupilcol,NUM)
...
[~,index_onset] = findpeaks(onset_set,'minPeakHeight',max(std_pupil/SCREEN.smooth,10),'minPeakDistance',80);
[~,index_term_r] = findpeaks(rot90(term_set,2),'minPeakHeight',max(std_pupil/SCREEN.smooth,10),'minPeakDistance',80);
